...
RUN emcc --version && em++ --version && \
    ...
    emmake ninja -j $(nproc) qemu-system-x86_64 && \
    if [ -f qemu-system-x86_64.js ]; then mv qemu-system-x86_64.js /qemu-system-x86_64.js; else mv qemu-system-x86_64 /qemu-system-x86_64.js; fi && \
